...
const PostRouter = require("./routes/posts");// load  the routes  file  for posts  routes  and  export it  to  use it in the app.use() method  below.  .use() is a method of express.Router()  class.  It is used to mount middleware handlers to a specified path.
...
app.use("/api/posts", PostRouter);  //mount the posts routes to the /api/posts path.    .use() is a method of express.Router()  class.  It is used to mount middleware handlers to a specified path.
app.listen("5000", () => {
